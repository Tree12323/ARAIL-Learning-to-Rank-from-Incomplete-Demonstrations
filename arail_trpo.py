...
from guidance_mujoco import Guidance, Guidance_Rank
...
def reward_config(true_reward, discriminator_reward, guidance_reward, algo, loss_percent):
    ...
    if algo == 'trpo':
        ...
        return true_reward, alpha * discriminator_reward, (1-loss_percent) * guidance_reward
    else:
...
def traj_segment_generator(pi, env, reward_giver, reward_guidance, horizon, stochastic, algo, loss_percent):
    ...
    while True:
        ...
        g_rew = reward_guidance.get_rewards(ob, ac)
...
def main(args):
    ...
    if args.task == 'train':
        ...
        reward_guidance = Guidance_Rank(env, args.policy_hidden_size, expert_dataset=expert_dataset)
        train(env,
              args.seed,
              policy_fn,
              reward_giver,
